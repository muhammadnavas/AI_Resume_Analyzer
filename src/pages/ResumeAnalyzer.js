          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 rounded-2xl p-8 border border-blue-200/50 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Suggested Professional Summary</h3>
              </div>
        ...
        >
          ...
          <div className="text-gray-700 space-y-3">
            {section.content.map((paragraph, pIndex) => {
              ...
              if (isBulletPoint) {
                return (
                  <div key={pIndex} className="flex items-start space-x-3 bg-white/60 rounded-lg p-3 border border-white/50">
              ...
              if (sentences.length > 2 && paragraph.length > 150) {
                return (
                  <div key={pIndex} className="space-y-2">
                    {sentences.map((sentence, sIndex) => (
                      <div key={sIndex} className="flex items-start space-x-3 bg-white/60 rounded-lg p-3 border border-white/50">
                        <span className="text-blue-500 mt-1 flex-shrink-0 text-lg">•</span>
                        <p className="leading-relaxed text-sm flex-1">
                          {sentence.trim()}
                        </p>
