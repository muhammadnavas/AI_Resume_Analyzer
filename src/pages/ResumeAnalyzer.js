                  ...
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`py-4 px-1 border-b-2 font-medium text-sm transition-all duration-200 flex items-center space-x-2 ${
                        activeTab === tab.id
                          ? 'border-blue-500 text-blue-600 bg-white/50 rounded-t-lg'
                          : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-white/30 rounded-t-lg'
                      }`}
                    >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                      {[
                        ...
                        const score = analysisResults.rating.categories?.[item.key] || 0;
